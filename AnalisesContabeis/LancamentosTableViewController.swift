...
class LancamentosTableViewController: UITableViewController {
    ...
    var ListaPlanos: [LancamentosModel] = []
    var label = UILabel()
    ...
    func LoadLancamentos() {
        ...
        DataManager.loadLancamentos(empresa: EmpresaCod, competencia: Competencia, conta: Conta, onComplete: {(planos) in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! LancamentoTableViewCell
        
        cell.Preparecell(lancamento: ListaPlanos[indexPath.row])
